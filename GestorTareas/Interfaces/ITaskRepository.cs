...
string? search = null);
    ...
    LinkedTask? GetLinkedRelationById(int linkedTaskId);
    void DeleteLinkedRelation(LinkedTask linkedTask); bool AlreadyExistsCollaborator(int taskId, int userId);
    ...
    List<Task> GetLinkableTasks(int currentUserId, bool includeAllUsers, int? excludeTaskId = null);
};
